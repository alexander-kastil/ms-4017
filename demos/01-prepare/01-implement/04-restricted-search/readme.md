...
> **Restricted SharePoint Search is retiring.** It was only ever a short-term measure to buy time for permission and governance reviews. New enablement is **blocked from July 31, 2026**, and the feature is **fully retired by January 31, 2027**. Existing settings are **not** migrated automatically. Use **Restricted Content Discovery (RCD)** instead: tenants that already have Restricted SharePoint Search enabled should validate permissions, turn it off, and plan the transition to RCD.
...
[SharePoint Advanced Management](https://learn.microsoft.com/en-us/sharepoint/advanced-management) - identify and remediate oversharing (broad access, unmanaged sharing).

[Microsoft Purview for AI](https://learn.microsoft.com/en-us/purview/ai-microsoft-purview) - sensitivity labels, DLP, and auditing for Copilot data governance.
